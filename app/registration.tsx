        ...
        try {
            ...
            await set(ref(database, 'users/' + user.uid), {
                ...
                challenges: {
                    ...
                    reps: 0,
                    timeChallenge: 0,
                    challenge: {}, // Initialisez avec un tableau vide ou un objet approprié
                },
                dailyExercises: {
                    date: '', // Initialisez avec une date vide ou appropriée
                    exercises: {}
                },
            });

            router.replace('/'); // Redirige vers une page après l'inscription
        } catch (error: any) {
